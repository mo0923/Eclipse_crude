                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
								...
								<c:if test="${notice.re_step > 1 }">
									<!-- 5칸씩 들여쓰기 로직, 즉 댓글 레벨에 따라 5칸씩 증가 -->
									<c:forEach var="j" begin="1" end="${(notice.re_step-1)*3 }">
										&nbsp;
									</c:forEach>
									<img alt="img" src="./images/img_icon_reply.png">
								</c:if>
								
                                	<c:if test="${notice.email == 'import' }">
                                		<img style="width:25px; height:25px;" alt="img" src="./images/import_icon.png">  ${notice.email}&nbsp;&nbsp;|&nbsp;&nbsp; </span>
                                	</c:if>
                                	<c:if test="${notice.email == 'normal' }">
                                		<img style="width:25px; height:25px;" alt="img" src="./images/normal_icon.png"> ${notice.email}&nbsp;&nbsp;|&nbsp;&nbsp; 
                                	</c:if>
                                	
                                	<a href="GetNoticeCtrl?num=${notice.num }">${notice.subject }</a>
                            </td>
                            <td>${notice.writer }</td>
